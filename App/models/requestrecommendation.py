...
class RequestRecommendation(db.Model):
    ...
    Recommendation = db.relationship('Recommendation', uselist=False, backref='requestrecommendation', lazy=True, cascade="all, delete-orphan", nullable=True)
